...
//			for(int i=0; i<tabFields.size();i++){
//				TabField tf = (TabField)tabFields.elementAt(i);
//				if(tf.getExtent().contains(new XYPoint(gX+ tf.getManager().getHorizontalScroll(),gY))){
//					if(listener!=null){
//						listener.setSelectedTab(tf.getTabID());
//						listener.repaintTab();
//						listener.setTabOnFocus(false);
//						listener.drawBottomPanel();
//						return false;
