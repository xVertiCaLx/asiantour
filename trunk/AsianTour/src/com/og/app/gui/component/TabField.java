...
public class TabField extends Field {
    ...
    protected boolean navigationClick(int status, int time) {
        //System.out.println("TabField:navigationClick");
        if ( listener!=null ){
            listener.setSelectedTab(tabID);
            listener.repaintTab();
        }
        //fieldChangeNotify(1);
        //return true;
    ...
    protected void onFocus(int direction) {
        //System.out.println("TabField:onFocus:"+text);
        if ( listener!=null ){
    ...
    protected void onUnfocus() {
        //System.out.println("TabField:onUnfocus:"+text);
        if ( listener!=null ){
