...
public class ImageButtonField extends Field
{
    ...
    //final Bitmap btn_focus_left= Bitmap.getBitmapResource("res/btn_focus_left.png");
    //final Bitmap btn_focus_right= Bitmap.getBitmapResource("res/btn_focus_right.png");
    //final Bitmap btn_focus_center= Bitmap.getBitmapResource("res/btn_focus_center.png");
    ...
    private ImageButtonListener listener = null;
     ...
     public ImageButtonField (String text, long style)
     {
            ...
            fieldWidth = btn_left.getWidth()+btn_right.getWidth()+GuiConst.FONT_PLAIN.getAdvance(text)+padding*2;//btn.getWidth();//defaultFont.getAdvance(text) + (padding * 2);
   }
    ...
    protected void layout(int arg0, int arg1)
    {
     ...
     protected void paint(Graphics graphics)
     {
            ...
            //graphics.drawBitmap(0, 0, fieldWidth, fieldHeight, bitmaparr[focusstatus] , 0, 0);        
            int x = 0;
            graphics.drawBitmap(x, 0, btn_left.getWidth(), fieldHeight, btn_leftarr[focusstatus] , 0, 0);
            x=x+btn_left.getWidth();
            int textwidth = fieldWidth-btn_left.getWidth()-btn_right.getWidth();
            do{
                graphics.drawBitmap(x, 0, btn_center.getWidth(), fieldHeight, btn_centerarr[focusstatus], 0, 0);
                textwidth=textwidth-btn_center.getWidth();
                x=x+btn_center.getWidth();
            }while(textwidth>0); 
            graphics.drawBitmap(fieldWidth-btn_rightarr[focusstatus].getWidth(), 0, btn_right.getWidth(), fieldHeight, btn_rightarr[focusstatus] , 0, 0);
            ...
            graphics.drawText(text, (fieldWidth-textwidth)/2, (fieldHeight-textheight)/2);
    }
